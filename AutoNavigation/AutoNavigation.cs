...
namespace AutoNavigate
{
    public class AutoNavigation
    {
        ...
        public AutoNavigation(NavigationConfig config)
        {
            this.config = config;
        ...
        public static class Warp
        {
            ...
            public static bool TryWrap(AutoNavigation self, PlayerMove_Sail __instance)
            {
            ...
            public static bool HasWarpChance(AutoNavigation self, PlayerMove_Sail __instance)
            {
